...
public class addResult extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBackground(new java.awt.Color(173, 187, 218));
        ...
        jButton2.setBackground(new java.awt.Color(134, 151, 196));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try {
            ...
            ResultSet rs=st.executeQuery("SELECT * FROM studentinfo where rollNumber='"+roll+"'");
            
            if (rs.next()) {
                st.executeUpdate("Insert into resultinfo(rollNumber,physics,maths,em,dbms,os) values('"+roll+"','"+physics+"','"+maths+"','"+em+"','"+dbms+"','"+os+"')");
